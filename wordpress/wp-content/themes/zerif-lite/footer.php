...
<div class="container">
	<div class="col-xs-24 col-sm-24 col-md-12">
		<div class="panel-body"><span class="icon-hotline">HOTLINE: 0907.975.779 -</span>&nbsp;<span class="icon-email">EMAIL:</span><a href="mailto:kinhdoanh@quangcaophang.com">kinhdoanh@quangcaophang.com</a>
		</div>
	</div>
</div> <!-- / END CONTAINER -->
