		...
		<div class="site-container">
			...
			<div class="site-topbar-left">
				...
				<?php if ( get_theme_mod( 'freestore-website-site-add' ) ) : ?>
                	<span class="site-topbar-left-ad"><i class="fa fa-map-marker"></i> <?php echo wp_kses_post( get_theme_mod( 'freestore-website-site-add', false ) ) ?></span>
                <?php endif; ?>
			</div>
			
			<div class="site-topbar-right">
				<?php if ( get_theme_mod( 'freestore-website-head-no' ) ) : ?>
                	<span class="site-topbar-right-no"><i class="fa fa-phone"></i> <?php echo wp_kses_post( get_theme_mod( 'freestore-website-head-no', false ) ) ?></span>
				<?php endif; ?>
