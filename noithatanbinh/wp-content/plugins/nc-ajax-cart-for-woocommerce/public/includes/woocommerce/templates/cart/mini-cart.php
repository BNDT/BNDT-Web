...
<div  class="woocommerce">
	<ul>
		<li><a href="<?php echo WC()->cart->get_cart_url(); ?>" class="button wc-forward"><?php _e( 'Giỏ hàng', 'nc-ajax-cart-for-woocommerce' ); ?></a>
        <a href="<?php echo WC()->cart->get_checkout_url(); ?>" class="button checkout wc-forward"><?php _e( 'Thanh toán', 'nc-ajax-cart-for-woocommerce' ); ?></a></li>
	</ul>
</div>
<?php endif; ?>
